const Keyboard = {
  ...
  init() {
    ...
    this.elements.main.classList.add("keyboard-wrapper", "keyboard-wrapper--hidden");
    ...
    // Automatically use keyboardfpr elements with .use-keyboard-input
  ...
  open(initialVal, oninput, onclose) {
    ...
    this.elements.main.classList.remove("keyboard-wrapper--hidden");
  },
  ...
  close() {
    ...
    this.eventHandlers.oninput = oninput;
    this.eventHandlers.onclose = onclose;
    this.elements.main.classList.add("keyboard-wrapper--hidden");
  }
};

window.addEventListener("DOMContentLoaded", () => {
  Keyboard.init();
  // Keyboard.open("dcode", function (currenValue) {
  //   console.log("value changes! here it is: " + currenValue);
